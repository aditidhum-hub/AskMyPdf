...
try {
  if (typeof window !== 'undefined' && 'Worker' in window) {
    // Set worker source to local bundled worker for offline & reliable parsing
      ...
      if (rawContent.trim().length < 25) {
        ...
        boundingBoxes = [
          ...
          },
          {
            ...
            width: 84,
            height: 25,
            text: 'Scanned image section transcribed via Optical Character Recognition',
            confidence: 88,
          }
        ];
      }
